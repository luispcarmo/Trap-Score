  ...
  return (
    <header className="flex items-center justify-between pb-5 border-b border-neutral-200">
      <button onClick={onHome} className="flex items-center gap-2.5 group hover:opacity-80 transition">
        <div className="relative flex items-center justify-center h-10 w-10 rounded-lg bg-gradient-to-br from-blue-500 to-blue-700 shadow-md overflow-hidden flex-shrink-0">
          <div className="text-white font-bold text-xs tracking-tight">TS</div>
        </div>
